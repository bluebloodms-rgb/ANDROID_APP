...
class DPadWidget_Pitch(QWidget):
    ...
    def _apply_value(self, new_value):
        if new_value != self.current_value:
            ...
            if self.main_window and hasattr(self.main_window, 'update_steer_display'):
                self.main_window.update_steer_display(self.current_value)
